...
<?php
	...
	$query = $mysqli -> prepare("INSERT INTO demoDB (firstname, lastname, email) VALUES (?, ?, ?)");
...
<html>
	<head>
		<title>Record Entry Submitted</title>
		<meta charset="utf-8">
		...
		<header class="page-header header container-fluid">
			<div class="overlay"></div>
				<h1>Record created successfully.</h1>
					...
					<?php
					$query2 = "SELECT * FROM demoDB WHERE FirstName='$fname' AND LastName='$lname' AND Email='$email'";
